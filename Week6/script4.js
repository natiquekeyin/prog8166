...
// // let listCopy = list.map((element) => element > 2);

// // let listCopy2 = list.filter((element) => element > 2);

// // console.log(listCopy);
// // console.log(listCopy2);

// let names = ["Alan", "Bob", "Christina", "Alex", "Sunil", "Srinu"];

// let newNames = names.filter((name) => name.startsWith("S"));

// let newNames1 = names.map((name) => name.startsWith("S"));
